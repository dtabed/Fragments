...
class FirstFragement : Fragment() {
    ...
    override fun onCreateView(
        ...
        var v:View = inflater.inflate(R.layout.fragment_first_fragement, container, false)
        val hiBTN: Button = v.findViewById(R.id.button)
        hiBTN.setOnClickListener {
            Toast.makeText(context,"hi",Toast.LENGTH_LONG).show()
        }
        val byeBTN: Button = v.findViewById(R.id.button1)
